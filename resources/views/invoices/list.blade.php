    ...
    <table class="table invoice-data-table white border-radius-4 pt-1">
      ...
      <tbody>
        <tr>
          ...
          <td></td>
          <td>
            <a href="{{asset('/invoices/view/id')}}">INV-00956</a>
          </td>
          ...
          <td>
            <div class="invoice-action">
              <a href="{{asset('/invoices/view/id')}}" class="invoice-action-view mr-4">
                <i class="material-icons">remove_red_eye</i>
              </a>
              <a href="{{asset('/invoices/edit/id')}}" class="invoice-action-edit">
        ...
        <tr>
          ...
          <td> </td>
          <td>
            <a href="{{asset('/invoices/view/id')}}">INV-00349</a>
          </td>
        ...
        <tr>
          ...
          <td> </td>
          <td>
            <a href="{{asset('/invoices/view/id')}}">INV-00853</a>
          </td>
        ...
        <tr>
          ...
          <td> </td>
          <td>
            <a href="{{asset('/invoices/view/id')}}">INV-00452</a>
          </td>
        ...
        <tr>
          ...
          <td> </td>
          <td>
            <a href="{{asset('/invoices/view/id')}}">INV-00123</a>
          </td>
        ...
        <tr>
          ...
          <td> </td>
          <td>
            <a href="{{asset('/invoices/view/id')}}">INV-00153</a>
          </td>
        ...
        <tr>
          ...
          <td> </td>
          <td>
            <a href="{{asset('/invoices/view/id')}}">INV-00788</a>
          </td>
        ...
        <tr>
          ...
          <td> </td>
          <td>
            <a href="{{asset('/invoices/view/id')}}">INV-00326</a>
          </td>
        ...
        <tr>
          ...
          <td> </td>
          <td>
            <a href="{{asset('/invoices/view/id')}}">INV-00759</a>
          </td>
        ...
        <tr>
          ...
          <td> </td>
          <td>
            <a href="{{asset('/invoices/view/id')}}">INV-00999</a>
          </td>
        ...
        <tr>
          ...
          <td> </td>
          <td>
            <a href="{{asset('/invoices/view/id')}}">INV-00223</a>
          </td>
          <td><span class="invoice-amount">₹ 459.30</span></td>
